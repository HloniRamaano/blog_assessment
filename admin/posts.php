		...
		<div class="table-div"  style="width: 80%;">
			...
			<?php else: ?>
				<table class="table">
						...
						<!-- If role is admin then publish post -->
						<?php if ($_SESSION['user']['role'] == "Admin"): ?>
							<th><small>Publish</small></th>
						<?php endif ?>
						<th><small>Edit</small></th>
						<th><small>Top Blog</small></th>
					...
					<?php foreach ($posts as $key => $post): ?>
						<tr>
							...
							<td>
								<?php if (isTopPost($post['id']) != true): ?>
									<a class="fa fa-times btn publish"
										href="posts.php?top-post=<?php echo $post['id'] ?>">
									</a>
								<?php else: ?>
									<a class="fa fa-check btn unpublish"
									href="posts.php?remove-top-post=<?php echo $post['id'] ?>">
									</a>
								<?php endif ?>
							</td>
							<td>
